export const styles = {
	...
	spheres: {
		emotions: 'color: rgba(108, 145, 241, 1);',
		love:	'color: rgba(231, 122, 122, 1);',
		communication: 'color: rgba(92, 179, 231, 1);',
		health: 'color: rgba(130, 167, 93, 1);',
		career: 'color: rgba(240, 160, 101, 1);',
		finance: 'color: rgba(205, 160, 225, 1);',
		travel: 'color: rgba(112, 204, 176, 1);',
	}
}
